...
const page = () => {
  return (
    ...
    <div className='min-h-screen hover:select-none'>
      <h1 className='font-semibold text-4xl sm:ml-[40px] m-2 mt-[30px] ml-[30px]'>About</h1>
      <p className='sm:ml-[20px] max-w-[900px] mt-[10px] sm:p-5 p-6 sm:m-0 m-2 sm:text-lg'>
